...
class FontStyleEmbedderConfig:
    ...
    # Input rendering.
    # Native render size for the phrase image (width × ~height auto-computed).
    phrase_width: int = 1536
    phrase_font_size: int = 128
    # Square size to resize the phrase rendering to before CNN encoding.
    phrase_image_size: int = 128
